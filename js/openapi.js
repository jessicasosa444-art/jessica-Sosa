...
currentButton.addEventListener("click", function () {
  fetch("https://api.open-meteo.com/v1/forecast?latitude=40.74&longitude=-74.03&current=temperature_2m,wind_speed_10m&temperature_unit=fahrenheit&wind_speed_unit=mph")
...
forecastButton.addEventListener("click", function () {
  fetch("https://api.open-meteo.com/v1/forecast?latitude=40.74&longitude=-74.03&daily=temperature_2m_max,temperature_2m_min&forecast_days=1&temperature_unit=fahrenheit")
    .then(function (response) {
      return response.json();
    })
    .then(function (data) {
